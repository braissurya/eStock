...
<body>
	<div id="main" class="fullwidth">
		<div class="block" id="block-forms">
			<h3 class="tit"> Laporan ${judul_report } </h3>
					...
					<form method="post" target="_blank">
						<div class="columns wat-cf">
							<table class="nostyle" style="width: 500px;">
								...
								<tr>
									...
									<td>
										<select name="kategori" id="kategori_id">																							
											...
											<c:forEach items="${reff.AllKategori}" var="g">
								...
								<tr>
									<th><label>Merk</label></th>
									<td>
										<select name="merk" id="merk_id">																							
											<option value="">ALL</option>
											<c:forEach items="${reff.AllMerk}" var="g">
												<option value="${g.key}">${g.value}</option>											
											</c:forEach>
										</select>
									</td>
								...
								<tr>
									<th><label>Warna</label></th>
									<td>
										<select name="warna" id="warna_id">																							
											<option value="">ALL</option>
											<c:forEach items="${reff.AllWarna}" var="g">
												<option value="${g.key}">${g.value}</option>											
											</c:forEach>
										</select>
									</td>
