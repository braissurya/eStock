...
<body>
	<div style="float: right; padding-top: 10px;padding-right: 10px;">
	   ...
	   <a href="javascript:doAction('${path}/transaksi/${gudang.jenistrans }/Gudang', 'Find Order ${trans.jenistrans }',1000,500,false);" title="Find Order ${trans.jenistrans }"><img alt="Find Order ${trans.jenistrans }" title="Find Order ${trans.jenistrans}" src="${path }/static/images/icons/findlist.png"></a>
	  </div>
	<h1>Gudang ${gudang.jenistrans } &gt; ${gudang.mode }
	 </h1>
	...
	<c:choose>
   	   ...
   	   <c:choose>
       		    ...
       		    <form:form commandName="gudang" name="formpost" method="POST"  cssClass="form" >
          		    <div class="block" id="block-forms">
			            ...
			            <div class="inner">
				                  ...
				                  <form:input path="trans_no"  id="trans_no" cssClass="text_field target" size="20" maxlength="14"/>
	               		...
	               		<div class="group navform wat-cf">
					         ...
					         <form:hidden path="jenistrans"/>
		               		<button class="button" type="submit" name="cari" id="cari" >
			                    <img src="${path }/static/decorator/main/pilu/images/icons/tick.png" alt="Cari" /> Cari
			                </button>
			                 <span class="text_button_padding"></span>
			                  <button class="button" type="button" onclick="if(confirm('Are you sure want to cancel?'))window.location='${path}/gudang/${jenistrans }'">
             ...
             <c:otherwise>
			    <form:form commandName="gudang" name="formpost" method="POST" action="${path}/gudang/save" cssClass="form" >
...
<!-- 											 		(<input type="text" size="10" name="diskon_${t.urut}" disabled="disabled" id="diskon_${t.urut}" value="<fmt:formatNumber pattern="#,##0">${t.jumlah_diskon}</fmt:formatNumber>"  class="text_field nominal"  title="${t.urut}"/>) -->
									...
									<c:when test="${gudang.jenistrans eq \"Pembelian\" }">
										<c:forEach items="${gudang.trans.lsTransDet }" var="t">
											<tr>
												...
												<td>${t.barcode_ext }<input type="hidden" name="item_id_${t.urut}" id="item_id_${t.urut}" value="${t.item_id }"  title="${t.urut}"/><input type="hidden" name="barcode_ext_${t.urut}" value="${t.barcode_ext }"  title="${t.urut}"/></td>
											 	<td>${t.item_idKet}<input type="hidden" name="nama_${t.urut}" id="nama_${t.urut}" value="${t.item_idKet}"  title="${t.urut}"/></td>
<!-- 											 	<td class="right"><input type="text" disabled="disabled"  name="harga_${t.urut}" id="harga_${t.urut}" size="10"  value="<fmt:formatNumber pattern="###0.00">${t.harga}</fmt:formatNumber>"  class="text_field number"  title="${t.urut}"/></td> -->
<!-- 											 	<td class="right" colspan="2"> -->
<!-- 											 		<input type="text" size="4" disabled="disabled" name="persen_diskon_${t.urut}" id="persen_diskon_${t.urut}" size="5" value="<fmt:formatNumber pattern="###0.00">${t.persen_diskon}</fmt:formatNumber>"  class="text_field number"  title="${t.urut}"/>% -->
<!-- 											 		(<input type="text" size="16" disabled="disabled" name="diskon_${t.urut}" id="diskon_${t.urut}" size="10" value="<fmt:formatNumber pattern="#,##0">${t.jumlah_diskon}</fmt:formatNumber>"  class="text_field nominal"  title="${t.urut}"/>)			 -->
<!-- 											 	</td> -->
<!-- 											 	<td class="right"><input type="text" disabled="disabled"  id="qty_${t.urut}" name="qty_${t.urut}" value="${t.qty}" size="4" class="text_field number"  title="${t.urut}"/></td> -->
												<td class="right">${t.qty}<input type="hidden" id="qty_${t.urut}" name="qty_${t.urut}" value="${t.qty}" size="4" class="text_field number"  title="${t.urut}"/></td>
											 	<td>${t.satuan_idKet}<input type="hidden" name="satuan_${t.urut}" id="satuan_${t.urut}" value="${t.satuan_idKet}"  title="${t.urut}"/></td>
...
<!-- 										(<input type="text" name="total_disc" disabled="disabled"   id="total_disc" size="10" value="<fmt:formatNumber pattern="#,##0">${gudang.trans.total_disc}</fmt:formatNumber>" size="16" class="text_field nominal" style="text-align: right;" />) -->
<!-- 									</td> -->
<!-- 									<td></td> -->
<!-- 								</tr> -->
<!-- 								<tr> -->
