...
<body>
	<h1>Closing &gt; Cabang ${user.namaCabang } </h1>
	<c:choose>
   		...
   		<c:otherwise>
    			...
    			<p class="msg info">Silahkan klik "Process Closing" untuk memproses closing cabang ${user.namaCabang } periode <fmt:formatDate pattern="MMMMM yyyy" value="${periode }"/> </p>
