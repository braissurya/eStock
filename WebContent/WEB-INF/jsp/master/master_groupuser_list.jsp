			...
			<tr <c:choose><c:when test="${(s.count % 2) eq 0}">class="odd"</c:when><c:otherwise>class="even"</c:otherwise></c:choose>>
				...
				<td class="last">
						<a href="${path}/admin/user/${p.id}" title="Group User">
	                      <img src="${path }/static/decorator/main/pilu/images/icons/userlist.png" alt="Group User" />
	                    </a>
						<a href="${path}/admin/groupuser/edit/${p.id}" title="edit">
	                      <img src="${path }/static/decorator/main/pilu/images/icons/application_edit.png" alt="Edit" />
	                    </a>
	                    <a href="${path}/admin/groupuser/view/${p.id}" title="view">
	                      <img src="${path }/static/decorator/main/pilu/images/icons/view.png" alt="View" />
	                    </a>
	                    <a href="javascript:if(confirm('Are you sure want to Delete \'Id : ${p.id}\' ?'))window.location='${path}/admin/groupuser/delete/${p.id}';" title="delete">
		 ...
		 <span class="datacount">
           ...
           <span class="page">Page : ${page } / ${totalPage }</span>
                ...
                <div class="innerButtom">
                  <div class="actions">
                    <button class="button" type="button" onclick="window.location='${path}/admin/groupuser/new';">
